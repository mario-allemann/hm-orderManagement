...
public class DomänenmodellPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Domänenmodell";
	...
	private DomänenmodellPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new DomänenmodellPersistentManager();
		}
